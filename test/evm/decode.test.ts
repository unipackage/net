...
const evmInputOnlyOneParamDecode = {
    ok: true,
    data: {
        method: "appendDatasetCollateral",
        params: { datasetId: BigInt(1) },
    },
}
...
describe("Encoding and decoding test", () => {
    ...
    describe("decodeTxInput Test", () => {
        ...
        it("web3 correct test(one param)", () => {
            ...
            assert.deepStrictEqual(web3Decode, evmInputOnlyOneParamDecode)
        })
        ...
        it("ethers correct test(one param)", () => {
            ...
            assert.deepStrictEqual(ethersDecode, evmInputOnlyOneParamDecode)
        })
